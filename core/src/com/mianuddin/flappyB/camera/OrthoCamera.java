package com.mianuddin.flappyB.camera;
...
public class OrthoCamera extends OrthographicCamera {
	...
	public OrthoCamera() {
		this(new VirtualViewport(flappyB.WIDTH, flappyB.HEIGHT));
	}
	...
	public void resize() {
		VirtualViewport virtualViewport = new VirtualViewport(flappyB.WIDTH, flappyB.HEIGHT);
